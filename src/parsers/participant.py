...
from src.sqlstore.match import SQLMatch, SQLParticipant, SQLParticipantStats, SQLStatPerk, SQLStyle, SQLStyleSelection, \
    SQLChallenges


def parse_participant_data(session: sqlalchemy.orm.Session, match: SQLMatch, participant: dict) -> None:
    """
